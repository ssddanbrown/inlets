...
echo ""
echo "Alternatively, if you wish to see the open source version "
echo "remain available, then become a GitHub Sponsor"
echo ""
echo "Find out more at: https://github.com/sponsors/inlets" 
echo ""
echo "================================================================"
echo ""
